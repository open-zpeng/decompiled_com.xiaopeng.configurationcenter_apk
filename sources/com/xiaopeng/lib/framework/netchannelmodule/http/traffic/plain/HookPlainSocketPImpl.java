...
public class HookPlainSocketPImpl extends SocketImpl {
    ...
    protected void close() throws IOException {
        invoke(getMethod("close", mSuperClass, "close", new Class[0]), true, this.mDelegate, new Object[0]);
    }
    ...
    protected void connect(String str, int i) throws IOException {
        ...
        this.mDomain = str + ":" + i;
        invoke(getMethod("connect0", mSuperClass, "connect", String.class, Integer.TYPE), true, this.mDelegate, str, Integer.valueOf(i));
    ...
    protected void connect(InetAddress inetAddress, int i) throws IOException {
        ...
        this.mDomain = inetAddress.getHostName() + ":" + i;
        invoke(getMethod("connect1", mSuperClass, "connect", InetAddress.class, Integer.TYPE), true, this.mDelegate, inetAddress, Integer.valueOf(i));
        this.mCounter.increaseRequest(this.mDomain, 0L);
    }
    ...
    protected void connect(SocketAddress socketAddress, int i) throws IOException {
        ...
        invoke(getMethod("connect2", mSuperClass, "connect", SocketAddress.class, Integer.TYPE), true, this.mDelegate, socketAddress, Integer.valueOf(i));
        this.mCounter.increaseRequest(this.mDomain, 0L);
    }
