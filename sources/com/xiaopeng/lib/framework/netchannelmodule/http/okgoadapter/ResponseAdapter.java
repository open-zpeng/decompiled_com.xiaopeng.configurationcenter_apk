...
public class ResponseAdapter implements IResponse {
    ...
    private e<String> mInternalResponse;
    private Response mRawResponse;

    public ResponseAdapter(e eVar) {
    ...
    public String body() {
        Response response = this.mRawResponse;
        if (response == null) {
            String c = this.mInternalResponse.c();
            if (c != null && mEnableStat) {
                HttpCounter.getInstance().addReceivedSize(this.mDomain, c.length());
            }
            return c;
        }
        String str = null;
