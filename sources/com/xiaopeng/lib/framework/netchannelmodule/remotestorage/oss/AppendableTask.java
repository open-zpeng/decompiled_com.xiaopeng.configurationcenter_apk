        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    doFailure(new StorageExceptionImpl(StorageException.REASON_UPLOAD_ERROR, valueOf));
                    ...
                    doFailure(new StorageExceptionImpl(StorageException.REASON_UPLOAD_ERROR, e.toString()));
