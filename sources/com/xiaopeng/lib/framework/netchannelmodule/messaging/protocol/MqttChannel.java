...
public class MqttChannel {
    ...
    private synchronized void closeCurrentConnection() {
        ...
        try {
            ...
            this.mMqttAndroidClient.a((org.eclipse.paho.a.a.c) null);
        } catch (Exception e) {
    ...
    public void disconnectConnection() {
        ...
        try {
            k kVar = this.mMemoryPersistence;
            if (kVar != null) {
                kVar.close();
            }
        } catch (Exception e2) {
    ...
    public boolean connectMqtt() throws MessagingException {
        if (this.mMqttAndroidClient == null || this.mMqttConnectOptions == null) {
            ...
            try {
                ...
                this.mMqttAndroidClient.a(this.mMqttConnectOptions, this.mApplicationContext, new org.eclipse.paho.a.a.c() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.MqttChannel.5
                    @Override // org.eclipse.paho.a.a.c
                    public void onSuccess(g gVar) {
                        MqttChannel.this.logInternal("onSuccess asyncActionToken=" + gVar);
                        try {
                            if (MqttChannel.this.mChannelProfile.canPublish()) {
                                MqttChannel.this.mMqttAndroidClient.a(MqttChannel.this.mChannelProfile.buildBufferOptions());
                            }
                    ...
                    public void onFailure(g gVar, Throwable th) {
                        ...
                        try {
                            MqttChannel.this.mMqttAndroidClient.d();
                            MqttChannel.this.mMqttAndroidClient.a((org.eclipse.paho.a.a.c) null);
                        } catch (n e) {
                            e.printStackTrace();
                        }
                        if (th != null) {
                        ...
                        MqttChannel.this.log("onFailure asyncActionToken=" + gVar + " exception=" + th);
                    }
                });
                return true;
            } catch (Exception e) {
    ...
    private boolean initAndroidClientSuccess() throws MessagingException {
        ...
        k kVar = this.mMemoryPersistence;
        if (kVar instanceof MemoryPersistenceProxy) {
            ((MemoryPersistenceProxy) kVar).setTraceEnabled(this.mChannelProfile.enableTrace());
        }
        this.mMqttAndroidClient = new d(this.mApplicationContext, serverUrl, clientId, this.mMemoryPersistence);
        this.mMqttAndroidClient.a(this.mMqttCallback);
        this.mMqttAndroidClient.a(this.mChannelProfile.enableTrace());
    ...
    public void subscribeInternal(final String str) {
        if (this.mScheduler.allowToSubscribe()) {
            try {
                this.mMqttAndroidClient.a(str, this.mChannelProfile.defaultQoSLevel(), (Object) null, new org.eclipse.paho.a.a.c() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.MqttChannel.8
                    @Override // org.eclipse.paho.a.a.c
                    public void onSuccess(g gVar) {
    ...
    public long publishMessage(String str, byte[] bArr, int i) throws MessagingException {
        ...
        synchronized (this) {
            ...
            try {
                ...
                j = this.mMqttAndroidClient.a(str, oVar, (Object) null, new org.eclipse.paho.a.a.c() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.MqttChannel.9
                    @Override // org.eclipse.paho.a.a.c
                    public void onSuccess(g gVar) {
                    }
                    ...
                    public void onFailure(g gVar, Throwable th) {
                        ...
                        if (th instanceof n) {
                            n nVar = (n) th;
                            MqttChannel.this.mEventSender.postDeliveryFailure(gVar.f(), nVar.a());
                            str2 = "Failed to publish, exception (A):" + nVar;
                            MqttChannel.this.logInternal(str2);
                        } else {
                            String str3 = "Failed to publish, exception (B):" + th;
                            MqttChannel.this.logInternal(str3);
                            MqttChannel.this.mEventSender.postDeliveryFailure(gVar.f(), 0);
                            str2 = str3;
                        }
                ...
                if (e instanceof n) {
                    this.mEventSender.postDeliveryFailure(0L, ((n) e).a());
                } else {
    ...
    /* loaded from: classes.dex */
    public class MqttCallbackImpl implements j {
        ...
        public void connectComplete(boolean z, String str) {
            ...
            if (MqttChannel.this.mMqttAndroidClient.a()) {
                MqttChannel.this.mScheduler.moveTo(Scheduler.STATE.CONNECTED);
            } else {
                MqttChannel.this.mScheduler.moveTo(Scheduler.STATE.DISCONNECTED);
            }
        ...
        public void messageArrived(String str, o oVar) {
            ...
            MqttChannel.this.mEventSender.postReceivedMessage(str, oVar.a());
            MqttChannel.this.mScheduler.resetFail();
            if (MqttChannel.this.mCounter != null) {
        ...
        public void deliveryComplete(e eVar) {
            if (BuildInfoUtils.isUserVersion()) {
                MqttChannel.this.mEventSender.postDeliveryCompleted(eVar.f());
            } else {
                try {
                    MqttChannel.this.mEventSender.postDeliveryCompleted(eVar.f(), eVar.a().a());
                } catch (Exception e) {
    ...
    public class ExtremePingSender {
        ...
        private org.eclipse.paho.a.a.c mPingActionListener;
        ...
        private ExtremePingSender() {
            ...
            this.mPingActionListener = new org.eclipse.paho.a.a.c() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.MqttChannel.ExtremePingSender.1
                @Override // org.eclipse.paho.a.a.c
                public void onSuccess(g gVar) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public boolean sendExtremePing(org.eclipse.paho.a.a.c cVar) throws MessagingException {
            boolean z = false;
            if (MqttChannel.this.isConnected()) {
                synchronized (this) {
                    try {
                        MqttChannel.this.mMqttAndroidClient.b(cVar);
                        z = true;
                    } catch (Exception e) {
        ...
        private SchedulerClient() {
            ...
            this.mUnexpectedHandlingAction = new Runnable() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.MqttChannel.SchedulerClient.3
                ...
                public void run() {
                    ...
                    LogUtils.d("NetChannel-MqttChannel", "mUnexpectedHandlingAction: connected state = " + MqttChannel.this.mScheduler.connected() + ", " + MqttChannel.this.mMqttAndroidClient.a());
                    if (MqttChannel.this.mScheduler.connected() || MqttChannel.this.mMqttAndroidClient.a()) {
                        MqttChannel.this.disconnectConnection();
