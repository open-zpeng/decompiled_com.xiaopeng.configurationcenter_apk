...
public class BugHunter {
    ...
    public static void init(Context context, boolean z, boolean z2, boolean z3) {
        try {
            ...
            Module.get(a.class).get(IDataLog.class);
        } catch (Throwable th) {
            th.printStackTrace();
        }
    }
            ...
            public void onBlockOccurs(String[] strArr, boolean z4, long... jArr) {
                ...
                while (true) {
                    ...
                    if (i2 == length) {
                        ...
                        sb.append(strArr[i]).append(BugHunter.SEPARATOR);
                        i--;
                    }
                }
                long j3 = jArr[0];
                ...
                IModuleEntry iModuleEntry = Module.get(a.class);
    ...
    public static String printStackTrace(String str, Context context, String str2, String[] strArr, long j, long j2) {
        ...
        if (context != null) {
            ...
            long j6 = memoryInfo.availMem / FileUtils.SIZE_1MB;
            j4 = memoryInfo.totalMem / FileUtils.SIZE_1MB;
            j3 = memoryInfo.threshold / FileUtils.SIZE_1MB;
