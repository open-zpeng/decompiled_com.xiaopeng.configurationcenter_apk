...
public class StackTraceCollector implements Collector {
    ...
    public void stop() {
        ...
        this.mCollectorHandler.removeMessages(MSG_COLLECT_CONTINUE);
    }
    ...
    public class CollectorHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            if (message.what == 54 || message.what == StackTraceCollector.MSG_COLLECT_CONTINUE) {
                if (message.what == 54) {
                ...
                if (StackTraceCollector.this.isWatching()) {
                    StackTraceCollector.this.trigger(StackTraceCollector.MSG_COLLECT_CONTINUE);
                }
            }
        }
    }
