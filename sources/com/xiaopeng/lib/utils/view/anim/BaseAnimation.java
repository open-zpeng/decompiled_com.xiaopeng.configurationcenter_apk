...
public class BaseAnimation {
    ...
    private void runHorizonLeftAnimation(View view, long j) {
        ...
        ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(view, ANIM_ALPHA, 0.0f, 1.0f);
    ...
    private void runRotateAnimation(View view, long j) {
        ...
        ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(view, ANIM_ALPHA, 0.0f, 1.0f);
    ...
    private void runScaleAnimation(View view, long j) {
        ...
        ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(view, ANIM_ALPHA, 0.0f, 1.0f);
        animatorSet.setDuration(this.mDuration);
