...
public class LocalFileCert {
                ...
                try {
                    ...
                    try {
                        try {
                            ...
                            b.a().a(IpcConfig.AfterSalesConfig.IPC_DIAG_RESPONSE, e.getLocalizedMessage());
                            e.printStackTrace();
                        }
                        try {
                            open.close();
                    ...
                    b.a().a(IpcConfig.AfterSalesConfig.IPC_DIAG_RESPONSE, e2.getLocalizedMessage());
                    e2.printStackTrace();
                    return null;
                }
            }
            ...
            if (keyManagerArr == null) {
                try {
                    if (SecurityCommon.checkSystemUid(context)) {
                        ...
                        certificate = ((ISystemDelegate) Module.get(a.class).get(ISystemDelegate.class)).getCertificate();
                    }
    ...
    public static SSLSocketFactory getTLS2SocketFactory(Context context) {
        try {
            ...
            b.a().a(IpcConfig.AfterSalesConfig.IPC_DIAG_MAP_GAODE_LOG, e.getLocalizedMessage());
            e.printStackTrace();
            return null;
        }
    }
