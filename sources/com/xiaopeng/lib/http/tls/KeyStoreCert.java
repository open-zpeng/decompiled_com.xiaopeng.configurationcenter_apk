    ...
    public static SSLSocketFactory getTLS2SocketFactory() {
        ...
        try {
            ...
            if (!compositeX509TrustManager.isHasValidCert()) {
                b.a().a(IpcConfig.AfterSalesConfig.IPC_REQUEST_REPAIRMODE_STATUS, "no valid ssl factory");
            }
            ...
            b.a().a(IpcConfig.AfterSalesConfig.IPC_REQUEST_REPAIRMODE_STATUS, e.getLocalizedMessage());
            e.printStackTrace();
            return null;
        }
    }
    ...
    public static X509TrustManager getX509TrustManager() {
        try {
            ...
            if (!compositeX509TrustManager2.isHasValidCert()) {
                b.a().a(IpcConfig.AfterSalesConfig.IPC_DIAG_REQUEST, "no valid trust manager");
            }
            return compositeX509TrustManager2;
        } catch (Exception e) {
            b.a().a(IpcConfig.AfterSalesConfig.IPC_DIAG_REQUEST, e.getLocalizedMessage());
            e.printStackTrace();
            return null;
        }
    }
    ...
    private static class CompositeX509TrustManager implements X509TrustManager {
        ...
        public CompositeX509TrustManager(KeyStore keyStore) {
            ...
            try {
                ...
                keyStore2.load(null);
                String[] strArr = {"ca", "client", "server", "alias"};
                for (int i = 0; i < 4; i++) {
                    String str = strArr[i];
                    try {
