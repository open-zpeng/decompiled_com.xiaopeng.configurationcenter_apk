...
public class HttpsUtils {
    ...
    private static void initOkHttpClient(Application application) {
        ...
        com.b.a.a.a().a(application).a(buildOkHttpClient(application));
    ...
    private static void registerBroadcast(Context context) {
        ...
        context.registerReceiver(new BroadcastReceiver() { // from class: com.xiaopeng.lib.http.HttpsUtils.1
            ...
            public void onReceive(Context context2, Intent intent) {
                ...
                try {
                    com.b.a.a.a().a(HttpsUtils.buildOkHttpClient(context2));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    public static void setHttpInitEventListener(com.xiaopeng.lib.a aVar) {
        b.a(aVar);
    }
}
