...
public class b implements ISystemDelegate {
    ...
    public String getCertificate() throws RemoteException {
        ...
        Cursor query = this.f1313a.getContentResolver().query(Uri.parse("content://com.xiaopeng.system.delegate/cert/ssl"), null, null, null, null);
        if (query != null) {
            try {
    ...
    public void setSystemProperty(String str, String str2) throws RemoteException {
        ...
        this.f1313a.getContentResolver().update(parse, contentValues, null, null);
    }
}
