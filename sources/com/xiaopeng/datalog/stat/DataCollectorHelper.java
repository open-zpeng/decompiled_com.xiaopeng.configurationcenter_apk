...
public class DataCollectorHelper {
    ...
    */
    ...
    public void dumpCan2File() {
        ...
        a.a().a("candata", ZipUtils.compressForGzipAndBase64NoWrap(buildCanDataZipJson()), this.mContext);
    ...
    public void dumpCdu2File() {
        ...
        a.a().a("cdudata", ZipUtils.compressForGzipAndBase64NoWrap(buildCduDataZipJson()), this.mContext);
    ...
    */
    ...
    private String[] generateUploadInfos() {
        ...
        String str = BUCKET_NAME + "/log/" + BuildInfoUtils.getSystemVersion() + "/" + DateUtils.formatDate7(currentTimeMillis) + "/" + SystemPropertyUtil.getVehicleId();
