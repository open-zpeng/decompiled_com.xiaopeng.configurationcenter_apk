...
public class UTSecuritySDKRequestAuthentication implements IUTRequestAuthentication {
    ...
    private Class f1305a = null;

    /* renamed from: a  reason: collision with other field name */
    private Field f133a = null;

    /* renamed from: b  reason: collision with other field name */
    private Field f135b = null;

    /* renamed from: c  reason: collision with other field name */
    private Field f136c = null;

    /* renamed from: a  reason: collision with other field name */
    private Method f134a = null;
    private int z = 1;
    ...
    */
    ...
    public String getSign(String str) {
        ...
        if (this.g == null) {
            ...
            return null;
        } else if (str == null || this.b == null || (cls = this.f1305a) == null || this.f133a == null || this.f135b == null || this.f136c == null || this.f134a == null || this.c == null) {
            return null;
        } else {
            try {
                Object newInstance = cls.newInstance();
                this.f133a.set(newInstance, this.g);
                ((Map) this.f135b.get(newInstance)).put("INPUT", str);
                this.f136c.set(newInstance, Integer.valueOf(this.z));
                return (String) this.f134a.invoke(this.c, newInstance, this.ad);
