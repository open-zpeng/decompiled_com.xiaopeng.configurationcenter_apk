...
public class UTPageHitHelper {
    ...
    private static UTPageHitHelper f1298a = new UTPageHitHelper();
    ...
    private Queue<UTPageEventObject> f129a = new LinkedList();
    ...
    public static class UTPageEventObject {
        ...
        /* renamed from: a  reason: collision with root package name */
        private Uri f1299a = null;
        private String an = null;
        private String ao = null;

        /* renamed from: a  reason: collision with other field name */
        private UTPageStatus f130a = null;
        ...
        public void resetPropertiesWithoutSkipFlagAndH5Flag() {
            ...
            this.an = null;
            this.ao = null;
            UTPageStatus uTPageStatus = this.f130a;
    ...
    synchronized void a(UTPageEventObject uTPageEventObject) {
        ...
        if (!this.f129a.contains(uTPageEventObject)) {
            this.f129a.add(uTPageEventObject);
        }
        if (this.f129a.size() > 200) {
            for (int i = 0; i < 100; i++) {
                UTPageEventObject poll = this.f129a.poll();
    ...
    private String m65a(Object obj) {
        String simpleName;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized boolean m68a(Object obj) {
        if (obj != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized void m67a(Object obj) {
        if (obj != null) {
            UTPageEventObject a2 = a(obj);
            if (a2.getPageStatus() != null) {
                a2.setH5Called();
    ...
    private synchronized UTPageEventObject a(Object obj) {
        String m65a = m65a(obj);
        if (this.A.containsKey(m65a)) {
            return this.A.get(m65a);
        }
        UTPageEventObject uTPageEventObject = new UTPageEventObject();
        this.A.put(m65a, uTPageEventObject);
        uTPageEventObject.setCacheKey(m65a);
    ...
    private synchronized void m66b(Object obj) {
        String m65a = m65a(obj);
        if (this.A.containsKey(m65a)) {
            this.A.remove(m65a);
        }
    ...
    public synchronized void a(Object obj, String str, boolean z) {
        if (obj != null) {
            String m65a = m65a(obj);
            if (m65a != null && m65a.equals(this.al)) {
                return;
            }
            if (this.al != null) {
