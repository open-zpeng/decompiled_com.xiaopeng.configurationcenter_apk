...
public final class k {
    ...
    private static final Map<Class<?>, Class<?>> f1039a;
    ...
    static {
        ...
        f1039a = Collections.unmodifiableMap(hashMap);
        b = Collections.unmodifiableMap(hashMap2);
    }

    public static <T> Class<T> a(Class<T> cls) {
        Class<T> cls2 = (Class<T>) f1039a.get(a.a(cls));
    ...
    public static boolean a(Type type) {
        return f1039a.containsKey(type);
    }
}
