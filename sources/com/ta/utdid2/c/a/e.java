...
class e {
    ...
    public static final HashMap m63a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static final int[] m64a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
        try {
        ...
        if (!name.equals("null")) {
            if (name.equals("string")) {
                ...
                if (name.equals("float")) {
                    ...
                    xmlPullParser.next();
                    int[] m64a = m64a(xmlPullParser, "int-array", strArr);
                    strArr[0] = attributeValue;
                    return m64a;
                } else if (name.equals("map")) {
                    xmlPullParser.next();
                    HashMap m63a = m63a(xmlPullParser, "map", strArr);
                    strArr[0] = attributeValue;
                    return m63a;
