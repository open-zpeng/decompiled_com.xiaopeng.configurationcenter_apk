...
public class c {
    ...
    private com.ta.utdid2.c.a.c f125a;
    ...
    /* renamed from: a  reason: collision with other field name */
    private Pattern f127a = Pattern.compile("[^0-9a-zA-Z=/+]+");
    ...
    public c(Context context) {
        ...
        this.f125a = new com.ta.utdid2.c.a.c(context, ".DataStorage", "ContextData", false, true);
        this.f126a = new d();
    ...
    private void d() {
        ...
        if (cVar != null) {
            if (i.m57a(cVar.getString("UTDID2"))) {
            ...
            boolean z = false;
            boolean z2 = true;
            if (!i.m57a(this.b.getString("DID"))) {
                this.b.remove("DID");
                z = true;
            }
            if (!i.m57a(this.b.getString("EI"))) {
                this.b.remove("EI");
                z = true;
            }
            if (i.m57a(this.b.getString("SI"))) {
                z2 = z;
            } else {
                this.b.remove("SI");
            }
    ...
    private void g(String str) {
        com.ta.utdid2.c.a.c cVar;
        if (str == null || (cVar = this.f125a) == null || str.equals(cVar.getString(this.m))) {
            return;
        }
        this.f125a.putString(this.m, str);
        this.f125a.commit();
    }
    ...
    private String g() {
        ...
        if (cVar != null) {
            ...
            if (i.m57a(string) || this.f126a.a(string) == null) {
                return null;
            }
            return string;
        }
    ...
    private boolean b(String str) {
        if (str != null) {
            ...
            if (24 == str.length() && !this.f127a.matcher(str).find()) {
                return true;
            }
        }
        return false;
    ...
    public synchronized String h() {
        ...
        String string2 = this.f125a.getString(this.m);
        if (!i.m57a(string2)) {
            String b3 = eVar.b(string2);
            if (!b(b3)) {
                b3 = this.f126a.b(string2);
            }
            if (b(b3)) {
                String a4 = this.f126a.a(b3);
                if (!i.m57a(b3)) {
                    this.l = b3;
                    if (z) {
                        j(a4);
